...
export default function TargetAreasSection() {
  return (
    <section className="py-20 md:py-28 bg-white relative overflow-hidden">
      <div className="max-w-[1140px] mx-auto px-5 md:px-8 text-center">
        {/* Pill Tag */}
        ...
        {/* Heading */}
        <h2 className="font-['Playfair_Display'] text-3xl sm:text-4xl md:text-5xl text-gray-950 font-normal mb-4">
        ...
        <div className="relative rounded-[36px] overflow-hidden bg-white shadow-[0_16px_50px_rgba(0,0,0,0.06)] border border-gray-100 p-4 md:p-8 mb-12">
          <img 
        ...
        <div className="inline-flex items-center gap-3.5 sm:gap-4 bg-white/90 backdrop-blur-xl px-5 sm:px-8 py-3 sm:py-4 rounded-2xl sm:rounded-full shadow-[0_10px_30px_rgba(0,0,0,0.08)] border border-gray-100 max-w-full">
          <div className="w-12 h-12 rounded-full bg-[#108283] text-white flex items-center justify-center shadow-md shrink-0">
            <Phone className="w-5 h-5" />
          </div>
          <div className="text-left font-['Source_Sans_3']">
